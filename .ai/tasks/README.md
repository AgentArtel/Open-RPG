...
| [sprint-3-persistence](sprint-3-persistence/) | Phase 5 | Supabase memory, player state, AgentManager + YAML | TASK-012–014 | IN PROGRESS |
| [sprint-4-polish-deploy](sprint-4-polish-deploy/) | Phase 5 | Speech bubbles, conversation log GUI, Railway deploy | TASK-015–017 | PENDING |
| [sprint-5-api-identity-social](sprint-5-api-identity-social/) | Phase 6 | Photographer NPC, content store, associative recall, Lovable feed | TASK-018–021 | BACKLOG |
