...
**Phase**: 6
**Status**: NEXT
**Agent**: cursor (018a–020), lovable (021)

Modular skill plugin system, Photographer NPC with Gemini image generation (proof of API-as-Identity), NPC content store with semantic tagging, associative recall for environment-driven memory, and the Lovable social feed UI.

| Task | Title | Agent | Status |
|------|-------|-------|--------|
| TASK-018a | Modular Skill Plugin System | cursor | PENDING |
| TASK-018 | Photographer NPC + Image Generation Skill (Gemini) | cursor | PENDING |
...
**Research plan**: `.cursor/plans/sprint_5_research_and_plan_abbdc987.plan.md`
